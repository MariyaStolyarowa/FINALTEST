...
3. Метод заполнения
 нового массива элементами длинной <=3 символа из исходного массива *StayWithout*;
4. Метод печати массива на экран *PrintArray*.
...
Выводим на экран массивы: исходный и полученный с помощью метода PrintArray.
